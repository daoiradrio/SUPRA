...
class Optimizer:
    ...
    def refine_ff_opts(self, path_to_strucs: str) -> None:
        ...
        for i, struc in enumerate(strucs_list):
            ...
            subprocess.run(args=["xtb", "--opt", "normal", struc_path], cwd=new_workdir, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
