...
set label 1 "{/Symbol s} = 0.1114" font "arial,10" at 1600,-1
set key on
...
set label 1 "{/Symbol s} = 0.0437" font "arial, 10" at 1600,-1
set key on
set xlabel "wavenumber [1/cm]"
set ylabel "intensity"
set xrange [1000:1700]
...
set label 1 "{/Symbol s} = 0.2400" font "arial, 10" at 1600,-1
set key inside
set xlabel "wavenumber [1/cm]"
set ylabel "intensity"
set xrange [1000:1700]
